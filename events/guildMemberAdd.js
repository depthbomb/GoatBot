...
module.exports = (client, member) => {
	...
	if (!member.user.bot) {
		...
		member.roles.add(refugeeRole).then(mem => {
			client.log.info(`Sending welcome DM to new user, ${member.user.tag}.`);
	...
	client.log.info(`${member.user.tag} has joined ${member.guild.name}!`);
